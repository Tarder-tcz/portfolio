...
export default function DottedDialogDemo() {
    return (
        <div className="relative min-h-[500px] w-full bg-background text-foreground">
            <header className="fixed top-0 left-0 right-0 z-50 p-4 flex items-center justify-between border-b bg-background/50 backdrop-blur-md">
                <div className="flex items-center gap-4">
                    <MotionLogo className="w-[32px] h-[32px] fill-foreground" />
                    <span className="font-bold">Portfolio</span>
                </div>
                <nav className="flex gap-6 text-sm font-medium">
                    <a href="#" className="hover:text-muted-foreground transition-colors">Docs</a>
                    <a href="#" className="hover:text-muted-foreground transition-colors">Examples</a>
                    <a href="#" className="hover:text-muted-foreground transition-colors">Motion+</a>
                </nav>
            </header>

            <div className="flex flex-col items-center justify-center min-h-screen gap-10 pt-20">
                <div className="flex items-center gap-8 mb-10">
                    <div className="w-[150px] h-[150px] rounded-full bg-yellow-300 flex items-center justify-center shadow-2xl shadow-yellow-300/20">
                        <MotionLogo className="w-[100px] h-[100px]" color="fill-black" />
                    </div>
                    <div className="flex flex-col gap-2">
                        <h1 className="text-yellow-500 dark:text-yellow-300 text-6xl font-bold tracking-tighter">Motion</h1>
                ...
                <Dialog>
                    <DialogTrigger asChild>
                        <Button size="lg" className="rounded-full px-8 text-lg font-semibold shadow-lg hover:shadow-xl transition-all">Open Dialog</Button>
                    </DialogTrigger>
