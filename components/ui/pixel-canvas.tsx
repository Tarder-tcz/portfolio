...
const PixelCanvasElement = typeof HTMLElement !== "undefined" ? class PixelCanvasElement extends HTMLElement {
        ...
        React.useEffect(() => {
            if (typeof window !== "undefined") {
                if (!customElements.get("pixel-canvas")) {
                    customElements.define("pixel-canvas", PixelCanvasElement as CustomElementConstructor)
                }
            }
        }, [])
