...
interface MagicTextRevealProps {
    ...
    children?: React.ReactNode; // Added to support icons
}
...
export const MagicTextReveal: React.FC<MagicTextRevealProps> = ({
    ...
    useEffect(() => {
        ...
        // Reset lastTime to prevent huge delta after pause
    ...
    }, [isHovered, showText, spread, speed, globalDpr, updateParticles, renderParticles, isInView]);  // Handle resize with ResizeObserver
    useEffect(() => {
    ...
    }, [renderCanvas, wrapperSize, isInView]);
    ...
    return (
        <div
            ...
            style={{
                backgroundColor: 'rgba(15, 15, 15, 0.9)', // Increased opacity slightly to compensate for loss of blur
        ...
        >
            <div
                ...
                className={`absolute z-10 transition-opacity duration-200 ${showText ? 'opacity-100' : 'opacity-0'
                    } flex items-center gap-2`} // Added flex and gap
                style={{
                    color,
                    fontFamily,
                    fontWeight,
